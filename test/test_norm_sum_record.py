...
from apel.db.records import (NormalisedSummaryRecord, NormalisedSummaryRecord04,
...
class TestNormalisedSummaryRecord(unittest.TestCase):
    ...
    RECORD_TYPE = NormalisedSummaryRecord
    ...
    def _get_record_tuples(self):
        ...
        tuple1 = ('RAL-LCG2', 3, 2010, '/C=whatever/D=someDN', 'atlas',
                  '/atlas',   'Role=production', 'some.host.org', 'grid',
                  'APEL-CREAM-PBS', None,
        ...
        tuple2 = ('RAL-LCG2', 4, 2010, '/C=whatever/D=someDN', 'atlas',
                  '/atlas', 'Role=production', 'some.host.org', 'local',
                  'APEL-CREAM-HTCONDOR', None,
...
class TestNormalisedSummaryRecord04(TestNormalisedSummaryRecord):
    """Test for the NormalisedSummaryRecord04 class."""

    RECORD_TYPE = NormalisedSummaryRecord04
    ...
    def _get_record_text(self):
        ...
        record_text = """Site: RAL-LCG2
            ...
            WallDuration: 234256
            CpuDuration: 244435
            NormalisedWallDuration: {HEPscore23: 234256}
            NormalisedCpuDuration: {HEPscore23: 244435}
            NumberOfJobs: 100"""
        ...
        record_text2 = """Site: RAL-LCG2
            ...
            WallDuration: 234256
            CpuDuration: 244435
            NormalisedWallDuration: {hepspec: 234256}
            NormalisedCpuDuration: {hepspec: 244435}
            NumberOfJobs: 100"""
        ...
        record_text3 = """Site: RAL-LCG2
            ...
            WallDuration: 234256
            CpuDuration: 244435
            NormalisedWallDuration: {si2k: 234256}
            NormalisedCpuDuration: {si2k: 244435}
            NumberOfJobs: 100"""
