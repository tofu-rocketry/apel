...
class ParserPBSTest(unittest.TestCase):
    ...
    def test_parse(self):
        lines = (
            ...
            ('02/15/2015 00:00:26;E;2503618.grid.desu.cf;user=atlasprd005 group'
             '=atlasprd jobname=cream_454853282 queue=mcore ctime=1423949785 qt'
             'ime=1423949785 etime=1423949785 start=1423949810 owner=atlasprd00'
             '5@grid-cr4.desy.de exec_host=wn09.desu.cf/2 Resource_List.cput=60'
             ':00:00 Resource_List.neednodes=1:ppn=8 Resource_List.nodect=1 Res'
             'ource_List.nodes=1:ppn=8 Resource_List.pcput=60:00:00 Resource_Li'
             'st.walltime=90:00:00 session=22081 end=1423954826 Exit_status=0 r'
             'esources_used.cput=10:00:27 resources_used.mem=11685192kb resourc'
             'es_used.vmem=16983240kb resources_used.walltime=01:23:36'),
